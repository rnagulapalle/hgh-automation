...
public class GmailClient {
    ...
    public GmailClient() throws NoSuchProviderException {
    ...
    public GmailClient connect() throws MessagingException {
        try {
